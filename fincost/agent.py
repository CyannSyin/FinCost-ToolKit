...
def run_diagnosis(md_path: str, records_path: str | None, static_path: str, output_path: str | None = None) -> str:
    ...
    prompt = "\n".join(
        [
            ...
            "It can be reduce or increase the trading frequency, increase the model latency, reduce the model tokens, reduce the model infrastructure cost, reduce the model data subscription cost, reduce the model transaction cost, reduce the model token cost, reduce the model infrastructure cost.",
            "You can also give some suggestions for the trading system, such as the architecture of the trading system, the trading model, the trading strategy, the trading assets, the trading frequency, the trading time, the trading risk, the trading reward, the trading cost, the trading profit, the trading return, the trading risk, the trading reward, the trading cost, the trading profit, the trading return.",
